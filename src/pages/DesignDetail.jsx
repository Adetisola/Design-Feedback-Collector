...
export default function DesignDetail() {
    ...
    // Lock body scroll when DesignDetail is mounted (overlay mode)
    useEffect(() => {
    ...
    // Handle image overlay scroll lock
    useEffect(() => {
        if (imageOverlayOpen) {
            document.body.style.overflow = 'hidden';
        }
    ...
    return (
        <div className="fixed inset-0 z-50 bg-gradient-to-br from-purple-900/95 via-blue-900/95 to-indigo-900/95 backdrop-blur-sm overflow-y-auto pt-24">
            <div className="min-h-screen py-12 px-4">
                <div className="max-w-4xl mx-auto">
                    {/* Close/Back Button */}
                    <button
                    ...
                    >
                        ...
                        <div
                            ...
                            style={{
                                ...
                                height: window.innerWidth < 768 ? '30vh' : '80vh',
                                maxWidth: window.innerWidth < 768 ? '90vw' : '80vw',
                                maxHeight: window.innerWidth < 768 ? '30vh' : '80vh',
